...
contract Goodship is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7000000000 * 10**5 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Goodship";
    string private _symbol = "GOODSHIP";
    ...
    uint256 public _maxTxAmount = 5000000 * 10**5 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10**5 * 10**6;
